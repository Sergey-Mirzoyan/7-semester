...
class Algorithms():
    ...
    @staticmethod
    # tmp_phi * x + tmp_e * y = d
    # нужно найти коэффициент при tmp_e
    def advanced_euclide(tmp_phi, tmp_e): #Поиск НОД с параметрами
        x2, x1, y2, y1 = 1, 0, 0, 1 #единичная матрица
        while tmp_e > 0:
            q = tmp_phi // tmp_e #частное
            r = tmp_phi - q * tmp_e #остаток
